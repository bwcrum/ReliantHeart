...
public class OTA_Object_UByte_Array extends OTAObject implements iOTAMessage {

	public OTA_Object_UByte_Array(int objectid) throws Exception {
		super(objectid, iOTAMessage.OBJTYPE_ARRAY_UBYTE);
		obj_data = new byte[0];
		resize();
	...
	public OTA_Object_UByte_Array(int objectid, byte[] data) throws Exception {
		super(objectid, iOTAMessage.OBJTYPE_ARRAY_UBYTE);
		setValue(data);
	}
	
	
	public OTA_Object_UByte_Array(byte[] incoming) throws Exception {
		super(incoming);
		try {
	...
	public static void main( String args[])
	{
		...
		OTA_Object_UByte_Array obj = null;
		try {
			obj = new OTA_Object_UByte_Array(oid++);
		} catch (Exception e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
		...
		try {
			obj = new OTA_Object_UByte_Array(data);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
