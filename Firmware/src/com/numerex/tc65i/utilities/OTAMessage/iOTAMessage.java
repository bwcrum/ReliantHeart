...
public interface iOTAMessage {
	...
	final static public int OBJTYPE_MIME = 			8;
	final static public int OBJTYPE_UBYTE =         9;
	final static public int OBJTYPE_UINT =          10;
	final static public int OBJTYPE_ARRAY_UBYTE =   11;
	final static public int OBJTYPE_ARRAY_UINT  =   12;
	...
	final static public int MINOR_VERSION = 		1;
	...
	final static public int EVENT_POWER_UP = 		0;
