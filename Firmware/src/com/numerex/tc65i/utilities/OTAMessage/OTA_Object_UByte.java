...
public class OTA_Object_UByte extends OTAObject implements iOTAMessage {

	
	public OTA_Object_UByte(int objectid) throws Exception {
		super(objectid, iOTAMessage.OBJTYPE_UBYTE);
	    
	}
	
	public OTA_Object_UByte(int objectid, byte data) throws Exception {
		super(objectid, iOTAMessage.OBJTYPE_UBYTE);
		setValue(data);
		
	}
	
	public OTA_Object_UByte(byte[] incoming) throws Exception {
		super(incoming);
		try {
	...
	public static void main(String args[]) {
		...
		OTA_Object_UByte obj = null;
		try {
			obj = new OTA_Object_UByte(objid);
		} catch (Exception e2) {
			// TODO Auto-generated catch block
			e2.printStackTrace();
		}
		...
		data = (byte)0xAB;
		objid = 11;
		OTA_Object_UByte obj2 = null;
		try {
			obj2 = new OTA_Object_UByte(objid, data);
		} catch (Exception e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
		...
		byte[] in = {12, 0, 55}; 
		OTA_Object_UByte obj3;
		try {
			obj3 = new OTA_Object_UByte(in);
